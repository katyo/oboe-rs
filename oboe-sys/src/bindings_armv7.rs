...
extern "C" {
    #[link_name = "\u{1}_ZNSt6__ndk15mutex4lockEv"]
    pub fn std_mutex_lock(this: *mut std_mutex);
}
extern "C" {
    #[link_name = "\u{1}_ZNSt6__ndk15mutex8try_lockEv"]
    pub fn std_mutex_try_lock(this: *mut std_mutex) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZNSt6__ndk15mutex6unlockEv"]
    pub fn std_mutex_unlock(this: *mut std_mutex);
}
extern "C" {
    #[link_name = "\u{1}_ZNSt6__ndk15mutexD1Ev"]
...
#[repr(C)]
pub struct oboe_AudioStreamCallback__bindgen_vtable(::std::os::raw::c_void);
...
pub struct oboe_AudioStreamCallback {
    pub vtable_: *const oboe_AudioStreamCallback__bindgen_vtable,
}
#[test]
...
pub struct oboe_AudioStreamBase {
    ...
    pub mStreamCallback: *mut oboe_AudioStreamCallback,
...
fn bindgen_test_layout_oboe_AudioStreamBase() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_AudioStreamBase>())).mStreamCallback as *const _ as usize
        },
        4usize,
        concat!(
            "Offset of field: ",
...
pub type oboe_ManagedStream = std_unique_ptr;
...
extern "C" {
    #[doc = " Create and open a ManagedStream object based on the current builder state."]
    #[doc = ""]
    #[doc = " The caller must create a unique ptr, and pass by reference so it can be"]
    #[doc = " modified to point to an opened stream. The caller owns the unique ptr,"]
    #[doc = " and it will be automatically closed and deleted when going out of scope."]
    #[doc = " @param stream Reference to the ManagedStream (uniqueptr) used to keep track of stream"]
    #[doc = " @return OBOE_OK if successful or a negative error code."]
    #[link_name = "\u{1}_ZN4oboe18AudioStreamBuilder17openManagedStreamERNSt6__ndk110unique_ptrINS_11AudioStreamENS_20StreamDeleterFunctorEEE"]
    pub fn oboe_AudioStreamBuilder_openManagedStream(
        this: *mut oboe_AudioStreamBuilder,
...
impl oboe_AudioStreamBuilder {
    ...
    #[inline]
    pub unsafe fn openManagedStream(&mut self, stream: *mut oboe_ManagedStream) -> oboe_Result {
        oboe_AudioStreamBuilder_openManagedStream(self, stream)
    }
}
...
pub struct oboe_AudioStream {
    ...
    #[doc = " Number of frames which have been written into the stream"]
    #[doc = ""]
    #[doc = " This is signed integer to match the counters in AAudio."]
    #[doc = " At audio rates, the counter will overflow in about six million years."]
    pub mFramesWritten: std_atomic,
    #[doc = " Number of frames which have been read from the stream."]
    #[doc = ""]
    #[doc = " This is signed integer to match the counters in AAudio."]
    #[doc = " At audio rates, the counter will overflow in about six million years."]
    pub mFramesRead: std_atomic,
    pub mLock: std_mutex,
    pub mPreviousScheduler: ::std::os::raw::c_int,
...
fn bindgen_test_layout_oboe_AudioStream() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<oboe_AudioStream>())).mFramesWritten as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
            "::",
            stringify!(mFramesWritten)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<oboe_AudioStream>())).mFramesRead as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
            "::",
            stringify!(mFramesRead)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<oboe_AudioStream>())).mLock as *const _ as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_AudioStream>())).mPreviousScheduler as *const _ as usize
        },
        100usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
            "::",
            stringify!(mPreviousScheduler)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_AudioStream>())).mDataCallbackEnabled as *const _ as usize
        },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
            "::",
            stringify!(mDataCallbackEnabled)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_AudioStream>())).mErrorCallbackCalled as *const _ as usize
        },
        105usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_AudioStream),
            "::",
            stringify!(mErrorCallbackCalled)
        )
    );
}
extern "C" {
...
#[doc = " This struct is a stateless functor which closes a audiostream prior to its deletion."]
...
pub struct oboe_LatencyTuner {
    pub mStream: *mut oboe_AudioStream,
    pub mState: oboe_LatencyTuner_State,
    pub mMaxBufferSize: i32,
    pub mPreviousXRuns: i32,
    pub mIdleCountDown: i32,
    pub mLatencyTriggerRequests: std_atomic,
    pub mLatencyTriggerResponses: std_atomic,
}
...
pub type oboe_LatencyTuner_State = i32;
...
fn bindgen_test_layout_oboe_LatencyTuner() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<oboe_LatencyTuner>())).mStream as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mStream)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<oboe_LatencyTuner>())).mState as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_LatencyTuner),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_LatencyTuner>())).mMaxBufferSize as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mMaxBufferSize)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_LatencyTuner>())).mPreviousXRuns as *const _ as usize
        },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mPreviousXRuns)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_LatencyTuner>())).mIdleCountDown as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mIdleCountDown)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_LatencyTuner>())).mLatencyTriggerRequests as *const _
                as usize
        },
        20usize,
        concat!(
            ...
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mLatencyTriggerRequests)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<oboe_LatencyTuner>())).mLatencyTriggerResponses as *const _
                as usize
        },
        24usize,
        concat!(
            ...
            stringify!(oboe_LatencyTuner),
            "::",
            stringify!(mLatencyTriggerResponses)
        )
    );
}
extern "C" {
...
pub const oboe_Version_Minor: u8 = 3;
pub const oboe_Version_Patch: u16 = 0;
pub const oboe_Version_Text: &'static [u8; 6usize] = b"1.3.0\0";
pub const oboe_Version_Number: u32 = 16973824;
#[test]
...
extern "C" {
    #[link_name = "\u{1}_ZN4oboe26AudioStreamCallbackWrapper18onErrorBeforeCloseEPNS_11AudioStreamENS_6ResultE"]
...
extern "C" {
    #[link_name = "\u{1}_ZN4oboe26AudioStreamCallbackWrapper17onErrorAfterCloseEPNS_11AudioStreamENS_6ResultE"]
...
#[test]
fn __bindgen_test_layout_std_atomic_open0_int64_t_close0_instantiation() {
    assert_eq!(
...
#[test]
fn __bindgen_test_layout_std_atomic_open0_int64_t_close0_instantiation_1() {
    assert_eq!(
        ::std::mem::size_of::<std_atomic>(),
        8usize,
        concat!("Size of template specialization: ", stringify!(std_atomic))
...
#[test]
fn __bindgen_test_layout_std_atomic_open0_int32_t_close0_instantiation_1() {
    assert_eq!(
        ::std::mem::size_of::<std_atomic>(),
        4usize,
        concat!("Size of template specialization: ", stringify!(std_atomic))
